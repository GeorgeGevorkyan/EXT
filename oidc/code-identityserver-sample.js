...
document.getElementById('unHiddenVoicemailFunctions').addEventListener("click", () =>{ document.getElementById('VoicemailFunctions').hidden = false; document.getElementById('unHiddenVoicemailSettingsFunctions').hidden = true  }, false);
document.getElementById('unHiddenVoicemailSettingsFunctions').addEventListener("click", () =>{ document.getElementById('VoicemailFunctions').hidden = true; document.getElementById('unHiddenVoicemailSettingsFunctions').hidden = false }, false);
