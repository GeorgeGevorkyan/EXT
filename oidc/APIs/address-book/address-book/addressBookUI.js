function init(){
    ...
    document.getElementById('getContacts').addEventListener("click", () =>{ 
        ...
        getContacts(localStorage.getItem('access_token'), params? ('?' + params): '');
    });
    ...
    document.getElementById('getUserDetails').addEventListener("click", () =>{
        ...
        getUserDetails(localStorage.getItem('access_token'), params? ('?' + params): '');
    });
    ...
    document.getElementById('getContactsByJIDs').addEventListener("click", () =>{ 
        ...
        getContactsByJIDs(localStorage.getItem('access_token'), document.getElementById('jids').value, params ? ('?' + params): '');
    });
    document.getElementById('getSingleContact').addEventListener("click", () =>{ 
        ...
        getSingleContact(localStorage.getItem('access_token'), document.getElementById('id').value, params ? ('?' + params): '');
    });
